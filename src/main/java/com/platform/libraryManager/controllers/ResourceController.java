...
public class ResourceController {
    ...
    public String browseResources(
        ...
        if (keyword != null && !keyword.isEmpty()) {
            ...
            try {
                com.platform.libraryManager.enums.ResourceTypeEnum resourceType = 
                    com.platform.libraryManager.enums.ResourceTypeEnum.valueOf(type);
            ...
            // Filter by category
            try {
                com.platform.libraryManager.enums.ResourceCategoryEnum resourceCategory = 
                    com.platform.libraryManager.enums.ResourceCategoryEnum.valueOf(category);
        ...
        model.addAttribute("allTypes", com.platform.libraryManager.enums.ResourceTypeEnum.values());
        model.addAttribute("allCategories", com.platform.libraryManager.enums.ResourceCategoryEnum.values());
        model.addAttribute("allStatuses", com.platform.libraryManager.enums.ResourceStatusEnum.values());
    ...
    public String filterByType(
        ...
        try {
            com.platform.libraryManager.enums.ResourceTypeEnum resourceType = 
                com.platform.libraryManager.enums.ResourceTypeEnum.valueOf(type.toUpperCase());
