...
import com.platform.libraryManager.dto.responses.endpoints.library.add.AddLibraryErrorResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.add.AddLibraryResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.add.AddLibrarySuccessResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.edit.EditLibraryErrorResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.edit.EditLibraryResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.edit.EditLibrarySuccessResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.getAll.GetAllLibrariesResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.getAll.GetAllLibrariesSuccessResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.getUnique.GetUniqueLibraryErrorResponse;
...
import com.platform.libraryManager.dto.responses.endpoints.library.remove.RemoveLibraryErrorResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.remove.RemoveLibraryResponse;
import com.platform.libraryManager.dto.responses.endpoints.library.remove.RemoveLibrarySuccessResponse;
